...
namespace AjunaExample.RestService.Generated.Storage
{
    ...
    public interface ISchedulerStorage : IStorage
    {
        ...
        /// </summary>
        AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27 GetAgenda(string key);
    ...
    public sealed class SchedulerStorage : ISchedulerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27> _agendaTypedStorage;
        ...
        public SchedulerStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AgendaTypedStorage = new TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27>("Scheduler.Agenda", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27> AgendaTypedStorage
        {
            get
            {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27 GetAgenda(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AgendaTypedStorage.Dictionary.TryGetValue(key, out AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27 result))
            {
                return result;
            }
            else
