...
namespace AjunaExample.RestService.Generated.Storage
{
    ...
    public interface IMultisigStorage : IStorage
    {
        ...
        /// </summary>
        AjunaExample.NetApiExt.Generated.Model.pallet_multisig.Multisig GetMultisigs(string key);
    }
    ...
    public sealed class MultisigStorage : IMultisigStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.pallet_multisig.Multisig> _multisigsTypedStorage;
        ...
        {
            this.MultisigsTypedStorage = new TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.pallet_multisig.Multisig>("Multisig.Multisigs", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _multisigsTypedStorage property
        /// </summary>
        public TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.pallet_multisig.Multisig> MultisigsTypedStorage
        {
            get
            {
        ...
        ///  The set of open multisig operations.
        /// </summary>
        public AjunaExample.NetApiExt.Generated.Model.pallet_multisig.Multisig GetMultisigs(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (MultisigsTypedStorage.Dictionary.TryGetValue(key, out AjunaExample.NetApiExt.Generated.Model.pallet_multisig.Multisig result))
            {
                return result;
            }
            else
