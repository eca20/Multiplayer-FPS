...
namespace AjunaExample.RestService.Generated.Storage
{
    ...
    public interface ITreasuryStorage : IStorage
    {
        ...
        /// </summary>
        AjunaExample.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key);
        
        /// <summary>
        /// >> Deactivated
        ///  The amount which has been reported as inactive to Currency.
        /// </summary>
        Ajuna.NetApi.Model.Types.Primitive.U128 GetDeactivated();
        
        /// <summary>
        /// >> Approvals
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 GetApprovals();
    }
    ...
    public sealed class TreasuryStorage : ITreasuryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.pallet_treasury.Proposal> _proposalsTypedStorage;
        
        /// <summary>
        /// _deactivatedTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Ajuna.NetApi.Model.Types.Primitive.U128> _deactivatedTypedStorage;
        
        /// <summary>
        /// _approvalsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5> _approvalsTypedStorage;
        ...
        public TreasuryStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ProposalsTypedStorage = new TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.pallet_treasury.Proposal>("Treasury.Proposals", storageDataProvider, storageChangeDelegates);
            this.DeactivatedTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Primitive.U128>("Treasury.Deactivated", storageDataProvider, storageChangeDelegates);
            this.ApprovalsTypedStorage = new TypedStorage<AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5>("Treasury.Approvals", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<AjunaExample.NetApiExt.Generated.Model.pallet_treasury.Proposal> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.NetApi.Model.Types.Primitive.U128> DeactivatedTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5> ApprovalsTypedStorage
        {
            get
            {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public AjunaExample.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalsTypedStorage.Dictionary.TryGetValue(key, out AjunaExample.NetApiExt.Generated.Model.pallet_treasury.Proposal result))
            {
                return result;
            }
            else
        ...
        ///  The amount which has been reported as inactive to Currency.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Primitive.U128 GetDeactivated()
        {
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public AjunaExample.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 GetApprovals()
        {
