...
namespace AjunaExample.NetApiExt.Generated.Storage
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange)));
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> State(CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            var result = await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState>(parameters, token);
            return result;
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChange(CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            var result = await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange>(parameters, token);
            return result;
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(AjunaExample.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReportEquivocationUnsigned(AjunaExample.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
    ...
    public sealed class GrandpaConstants
    {
        ...
        /// </summary>
        public Ajuna.NetApi.Model.Types.Primitive.U32 MaxNominators()
        {
            var result = new Ajuna.NetApi.Model.Types.Primitive.U32();
        ...
        ///  can be zero.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Primitive.U64 MaxSetIdSessionEntries()
        {
