...
namespace AjunaExample.NetApiExt.Generated.Model.pallet_scheduler
{
    
    
    /// <summary>
    /// >> 335 - Composite[pallet_scheduler.Scheduled]
    /// </summary>
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        private Ajuna.NetApi.Model.Types.Base.BaseOpt<AjunaExample.NetApiExt.Generated.Types.Base.Arr32U8> _maybeId;
        ...
        /// >> call
        /// </summary>
        private AjunaExample.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded _call;
        ...
        /// >> origin
        /// </summary>
        private AjunaExample.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller _origin;
        
        public Ajuna.NetApi.Model.Types.Base.BaseOpt<AjunaExample.NetApiExt.Generated.Types.Base.Arr32U8> MaybeId
        {
            get
            {
        ...
        public AjunaExample.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded Call
        {
            get
            {
                return this._call;
        ...
        public AjunaExample.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller Origin
        {
            get
            {
                return this._origin;
        ...
        {
            var start = p;
            MaybeId = new Ajuna.NetApi.Model.Types.Base.BaseOpt<AjunaExample.NetApiExt.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Ajuna.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new AjunaExample.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
            ...
            Origin = new AjunaExample.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller();
