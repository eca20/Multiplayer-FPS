...
public class WalletController : Singleton<WalletController>
{
    ...
    public void OnLoadWalletEvent()
    {
        manager.LoadWallet(name, password);
    }
    public async void OnConnectEvent()
    {
        Connect(true);
    }
    public async void OnMoreEvent()
    {
